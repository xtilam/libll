...
public class PermissionServiceImpl implements PermissionService {
    ...
    public int update(Permission permission) {
        ...
        return this.em.createQuery(QueryString.UPDATE_PERMISSION.getQuery())//
                ...
                .setParameter("api", permission.getApi())//
    ...
    public int delete(Long id) {
        try {
            ...
            permission.put("modifiedBy", this.session.getAttribute("adminCode"));
    ...
    private Page<Map<String, Object>> findWithPagination(Pageable pageable, boolean isLastPage) {
        ...
        if (maxPage > pageable.getPageNumber()) {
            ...
            contentOfOutput = tQuery.getResultStream().map(values -> {
                ...
                item.put("api", values[5]);
                item.put("method", values[6]);
                item.put("modifiedBy", values[7]);
                item.put("modifiedDate", values[8]);
                item.put("id", values[9]);
                return item;
    ...
    public Map<String, Object> findPermissionUpdate(Long id) {
        ...
        output.put("api", item[5]);
        output.put("method", item[6]);
        output.put("modifiedBy", item[7]);
        output.put("modifiedDate", item[8]);
        output.put("id", item[9]);
        return output;
    }
