...
public interface AdminRepository extends Repository<Admin, Long> {
    ...
    int insertPermissionAdmin(@Param("id") Long id, @Param("adminCode") String adminCode, @Param("permissionCode") String permissionCode);
    ...
    static interface QueryString {
        ...
        static String GET_ALL_PERMISSION = "select"//
                ...
                + ",p.method as method"//
                + ",p.id as id"//
                + ",case when count(a.adminCode) > 0 then true else false end as isAllow"
                + " from Permission p" //
        ...
        static String GET_ALL_GROUP = "select"
